...
namespace SweetSugar.Scripts.Core
{
    ...
    public class LevelManager : MonoBehaviour
    {
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case GameState.Win://shows MenuComplete
                        ...
                        {
                            // MenuReference.THIS.EnterToWin.gameObject.SetActive(true);
                        ...
                        {
                            MenuReference.THIS.Reward.GetComponent<ScoreAnimation>().SetScore(LevelManager.Score);
                            MenuReference.THIS.Reward.gameObject.SetActive(true);
                        }
        ...
        public void EnableMap(bool enable)
        {
            ...
            if (!enable)
            {
                Vector3 pos = new Vector3(0, 0, -10) - (Vector3)orientationGameCameraHandle.offsetFieldPosition;
                pos.z = -1;
        ...
        private IEnumerator RegenMatches(bool onlyFalling = false)
        {
            ...
            field.GetItems().ForEach(i =>
            {
                ...
                LeanTween.scale(i.gameObject, transformLocalScale, .3f);
                i.Hide(false);
            });
        }
